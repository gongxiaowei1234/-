  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <!-- 品牌 -->
        <ul class="logo-list">
          <li v-for="(trademark,index) in trademarkList" :key="trademark.tmId" @click="sendTradeMarkHandle(trademark)">{{ trademark.tmName }}</li>
    ...
    <!-- 平台售卖属性 -->
    <div class="type-wrap" v-for="(attr,index) in attrsList" :key="attr.attrsId">
...
import { mapGetters } from "vuex";
  export default {
    ...
    methods:{
      sendTradeMarkHandle(trademark){
        // alert("123")
        //  console.log("我是子组件",trademark);
        //向父组件传数据， 第一个参数：自定义事件名称，  第二个参数：要传的参数
        this.$emit("trademarkInfo",trademark)
      //  this.$bus.$emit("trademarkHandle")
      },
      //传给父组件的数据
